...
class Vector
  ...
  def inspect; "V[#{self.to_a * ","}]"; end
    ...
    # converts the number into a string and replace it with a "1" or "0" casually generated
    ...
    # rate is the probability of mutation
    ...
    def crossover(parent1, parent2, rate)
        return ""+parent1 if rand >= rate # don't do the cross over if rand is maior or equal than the crossover probability 
        point = (rand*parent2.size).to_i # sets the crossover point randomly
